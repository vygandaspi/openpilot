...
def apply_driver_steer_torque_limits(apply_torque, apply_torque_last, driver_torque, LIMITS):
  ...
  driver_torque = driver_torque * LIMITS.STEER_DRIVER_FACTOR
  if apply_torque * driver_torque > 0:
    driver_max_torque = LIMITS.STEER_MAX + (LIMITS.STEER_DRIVER_ALLOWANCE_WITH * LIMITS.STEER_DRIVER_MULTIPLIER) - driver_torque * LIMITS.STEER_DRIVER_MULTIPLIER
    driver_min_torque = -LIMITS.STEER_MAX + (-LIMITS.STEER_DRIVER_ALLOWANCE_WITH * LIMITS.STEER_DRIVER_MULTIPLIER) - driver_torque * LIMITS.STEER_DRIVER_MULTIPLIER
  else:
    driver_max_torque = LIMITS.STEER_MAX + (LIMITS.STEER_DRIVER_ALLOWANCE_AGAINST + driver_torque) * LIMITS.STEER_DRIVER_MULTIPLIER
    driver_min_torque = -LIMITS.STEER_MAX + (-LIMITS.STEER_DRIVER_ALLOWANCE_AGAINST + driver_torque) * LIMITS.STEER_DRIVER_MULTIPLIER
